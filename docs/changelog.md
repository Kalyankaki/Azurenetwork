...
- platform: home page now carries a clear "No NRIVA membership required — open to all students and employers" callout below the existing eligibility pill, so visitors don't assume they need a membership account to sign up. Closes [#71](https://github.com/Kalyankaki/Azurenetwork/issues/71).
