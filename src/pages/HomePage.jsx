      ...
      <footer style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: 13, marginBottom: 8, display: 'flex', alignItems: 'center', gap: 8 }}>
              <span>📞</span> 1-855-WE-NRIVA
            </p>
            <p style={{ fontSize: 13, marginBottom: 8, display: 'flex', alignItems: 'center', gap: 8 }}>
              <span>✉️</span> <a href="mailto:info@nriva.org" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>info@nriva.org</a>
            </p>
            <p style={{ fontSize: 13, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
              <span>🌐</span> <a href="https://nriva.org" target="_blank" rel="noopener noreferrer" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>nriva.org</a>
            </p>
            <div style={{ display: 'flex', gap: 10 }}>
              {[
                { label: 'X', href: 'https://x.com/naborhood' },
                { label: 'f', href: 'https://facebook.com/naborhood' },
                { label: '▶', href: 'https://youtube.com/@naborhood' },
                { label: 'IG', href: 'https://instagram.com/naborhood' },
              ].map(s => (
